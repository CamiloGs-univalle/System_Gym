// ============================================
// PRODUCTOS ADMIN PANEL - Gestión de inventario
// ============================================
...
export default function ProductosAdminPanel() {
    ...
    return (
        <div className="inventario-container-full">
            <div className="inventario-header-full">
                <h2>📦 Gestión de Inventario</h2>
                <div className="inventario-stats-mini">
                    <span>📦 {totalProductos} productos</span>
                    <span>📊 {totalStock} unidades</span>
                    <span className={productosBajoStock > 0 ? "text-danger" : ""}>⚠️ {productosBajoStock} stock bajo</span>
                    <span>💰 {COP(valorInventario)}</span>
                </div>
            </div>

            {/* Toolbar */}
            <div className="inventario-toolbar-full">
            ...
            {/* Filtros */}
            <div className="inventario-filtros-full">
            ...
            {/* Lista de productos */}
            <div className="productos-scroll-full">
                <div className="categorias-lista-full">
                    {productosFiltrados.length === 0 ? (
                        <div className="inventario-vacio-full">
                        ...
                        productosFiltrados.map((categoria) => (
                            <div key={categoria.id} className="categoria-section-full">
                                <div className="categoria-header-full">
                                    <h4 className="categoria-titulo">📂 {categoria.nombre}</h4>
                                    <div className="categoria-acciones">
                                        <span className="categoria-count">{categoria.productos.length} productos</span>
                                        <button 
                                ...
                                <div className="productos-grid-full">
                                    {categoria.productos.map((producto) => {
                                        ...
                                        return (
                                            <div key={producto.id} className={`producto-card-full ${stockBajo ? 'stock-bajo-card' : ''}`}>
